  ...
  xl:max-w-[30vw] transition-all duration-300 z-20 px-4 lg:px-[35px]`}>
    ...
    <div className='flex flex-col gap-y-3 py-4 mt-4'>
      <div className='flex w-full justify-between items-center'>
        ...
        <div onClick={clearCart} className='cursor-poiter py-4 bg-red-500 text-white w-12 h-12 flex justify-center items-center text-xl'>
          <FiTrash2 />
        </div>
      </div>
      <Link
        to='/'
        className='bg-gray-200 flex p-4 justify-center items-center text-primary 
